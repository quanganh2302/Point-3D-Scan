...
{
    class DSM_MenuControlTable : ProfessionalColorTable
    {
        //Fields
        ...
        //Constructor
        public DSM_MenuControlTable(bool isMainMenu, Color primaryColor)
        {
            if (isMainMenu)
            {
            ...
            {
                backColor = Color.White; // --> BackColor of list drop down
