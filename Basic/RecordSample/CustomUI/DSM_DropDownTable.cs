...
{
    class DSM_DropDownTable: ContextMenuStrip
    {
        //Fields
        ...
        //Constructor
        public DSM_DropDownTable(IContainer container)
            : base(container)
        {
        }
        //Properties
        ...
        {
            if (isMainMenu)
                menuItemHeaderSize = new Bitmap(2, 45);
            else menuItemHeaderSize = new Bitmap(2, menuItemHeight);
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            {
                this.Renderer = new DSM_MenuRenderer(isMainMenu, primaryColor, menuItemTextColor);
                LoadMenuItemHeight();
            }
        }
    }
