...
{
    class DSM_MenuRenderer: ToolStripProfessionalRenderer
    {
        //Fields
        ...
        //Constructor
        public DSM_MenuRenderer(bool isMainMenu, Color primaryColor, Color textColor)
            : base(new DSM_MenuControlTable(isMainMenu, primaryColor))
        {
            ...
            else
            {
                arrowThickness = 2;
                if (textColor == Color.Empty) //Set Default Color
                    this.textColor = Color.DimGray; // --> Set fore color
                else//Set custom text color
                    this.textColor = textColor;
            }
        }
